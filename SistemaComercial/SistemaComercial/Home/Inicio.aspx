...
<%--    <link rel="stylesheet" type="text/css" href="~/Recurso/css/bootstrap.css" />
    ...
    <!--[if IE 7]>
        ...
        <![endif]-->
 <%--   <link href="../Recurso/css/jquery.bxslider.css" rel="stylesheet" />
    <link href="../Recurso/css/jquery.cslider.css" rel="stylesheet" />
    <link href="../Recurso/css/animate.css" rel="stylesheet" />--%>
...
<body>
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    ...
                    <div class="da-slide">
                        ...
                        <div class="da-img">
                            <img src="../Recurso/imagen/Slider01.png" alt="image01" width="320"/>
                        </div>
                    </div>
                    <!-- End first slide -->
                    <!-- Start second slide -->
                    <div class="da-slide">
                        ...
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="../Recurso/imagen/Slider02.png" width="320" alt="image02">
                        </div>
                    </div>
                    <!-- End second slide -->
                    <!-- Start third slide -->
                    <div class="da-slide">
                        ...
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="../Recurso/imagen/Slider03.png" width="320" alt="image03">
                        </div>
                    </div>
                    <!-- Start third slide -->
            ...
            <div class="container centered">
                <div class="sub-section">
                    ...
                    <ul class="row client-slider" id="clint-slider">
                        ...
                        <li>
                            <a href="">
                                <img src="../Recurso/imagen/clients/ClientLogo04.png" alt="client logo 4"/>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="../Recurso/imagen/clients/ClientLogo05.png" alt="client logo 5"/>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="../Recurso/imagen/clients/ClientLogo02.png" alt="client logo 6"/>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="../Recurso/imagen/clients/ClientLogo04.png" alt="client logo 7"/>
                            </a>
                        </li>
                    </ul>
                </div>
   ...
   <%-- <div class="navbar">
    ...
    <!-- Footer section start -->
    <div class="footer">
    <p>&copy; 2013 Theme by <a href="htt://www.graphbrry.com">GraphBerry</a>, <a href="htp://goo.gl/NM84K2">Documentation</a></p>
    </div>
    <!-- Footer section end -->
    <!-- ScrollUp button start -->
    <div class="scrollup">
